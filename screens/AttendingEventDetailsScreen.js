...
export default function AttendingEventDetailsScreen({ route, navigation }) {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View
        ...
        <Text style={{ fontSize: 15, borderBottomWidth: 1, marginTop: '5%' }}>
          Location
        </Text>
        ...
        <Text style={{ fontSize: 25 }}>
          {item.creator == currentUser.email
            ? 'Me, ' + item.creator
            : item.creator}
        </Text>
        <Text style={{ fontSize: 15, borderBottomWidth: 1, marginTop: '5%' }}>
